...
<body>
  ...
  <div class="container_searchimg">
      <img style="width: 100%" src="img/WangdueField.jpg">
        ...
        <div class="col-12 col-md-10 col-lg-8">
          <form class="card card-sm" action="search.html">
              <div class="card-body row no-gutters align-items-center">
                  ...
                  <!--end of col-->
                  <div class="col">
                      <input class="form-control form-control-lg form-control-borderless" type="search" placeholder="Search pests or hosts">
                  </div>
                  <!--end of col-->
                  <div class="col-auto">
  ...
  <!-- Page Content -->
  <div class="container bg-light" style="padding-left: 50px;padding-right: 50px; padding-top: 30px">

    <h1 class="my-4 text-secondary">Welcome to the Regulated Plants and Pests Database</h1>
    <br>
      ...
      <div class="col-sm-4">
         ...
         <ul class="nav nav-pills flex-column ">
            <li class="sidebar-brand h2 text-primary ">
              ...
              <a href="#overall" data-toggle="collapse" aria expanded="false">Forestry Pests </a>
             ...
             <li>
              ...
              <a href="#dashboard" data-toggle="collapse" aria expanded="false">Horticultural Pests </a>
            ...
            <li>
                ...
                <a href="#service" data-toggle="collapse" aria expanded="false">Agricultural Pests </a>
    ...
    <div class="row" id="faq">
      ...
      <div class="col-lg-6">
        <img class="img-fluid rounded" src="img/pests.jpg" alt="pests">
      </div>
    </div>
  </div>
